...
function PinterestIcon({ size = 24, ...props }: { size?: number } & React.SVGProps<SVGSVGElement>) {
  return (
    <svg
...
export function SocialSidebar() {
  return (
    <div className="fixed right-4 lg:right-8 top-1/2 -translate-y-1/2 z-50 flex flex-col gap-3 animate-[fadeIn_0.7s_ease-out_1.6s_both] motion-reduce:animate-none">
